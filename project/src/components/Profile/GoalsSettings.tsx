          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="w-12 h-12 bg-gray-200 hover:bg-gray-300 rounded-xl flex items-center justify-center text-gray-900 font-bold text-xl transition-all duration-200"
              >
                -
              </button>
              ...
              <input
                ...
                className="flex-1 bg-white border border-gray-300 text-gray-900 rounded-xl px-4 py-3 text-center text-xl font-bold focus:outline-none focus:ring-2 focus:ring-green-400"
              />
            ...
            <div className="space-y-3">
              <div className="bg-yellow-400/10 border border-yellow-400/30 rounded-xl p-4">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-800">Meta atual:</span>
                  <span className="text-gray-900 font-bold">{userData.targetWeight}kg</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-800">Nova meta:</span>
                  <span className="text-yellow-400 font-bold">{targetWeight}kg</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-800">Diferença:</span>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center py-3 border-b border-gray-200">
            <span className="text-gray-800">Peso inicial</span>
            <span className="text-gray-900 font-bold">{userData.initialWeight}kg</span>
          </div>
          
          <div className="flex justify-between items-center py-3 border-b border-gray-200">
            <span className="text-gray-800">Peso atual</span>
            <span className="text-gray-900 font-bold">{userData.currentWeight}kg</span>
          </div>
          
          <div className="flex justify-between items-center py-3 border-b border-gray-200">
            <span className="text-gray-800">Peso perdido</span>
          ...
          <div className="flex justify-between items-center py-3 border-b border-gray-200">
            <span className="text-gray-800">Meta de perda total</span>
          ...
          <div className="flex justify-between items-center py-3">
            <span className="text-gray-800">Média por dia</span>
